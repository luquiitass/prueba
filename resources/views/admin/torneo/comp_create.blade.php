<div>
    ...
    <div class="tab-content">
        <div id="liga" class="tab-pane fade in active">
            <div class="centered">
                <h3>Liga</h3>
                <img src="{{asset('img/liga.jpg')}}" height="300px" title="Imagen de una liga">
            </div>
            <p class="text-center">
            ...
            <div class="text-center">
                <a class="manita disabled edit " data-toggle="modal" data-target="#myModal" data-link="/admin/liga/create?temporada={{$temporada->id}}">Siguiente</a>
            </div>
        ...
        <div id="copa" class="tab-pane fade">
            <div class="centered">
                <h3>Copa</h3>
                <img src="{{asset('img/copa.jpg')}}" height="300px" title="Imagen de una liga">
            </div>
            <p class="text-center">
        ...
        <div id="desafio" class="tab-pane fade">
            <div class="centered">
                <h3>Desafio</h3>
                <img src="{{asset('img/desafio.png')}}" height="300px" title="Imagen de una liga">
            </div>
            <p class="text-center">
                Explicacion copada de xq una liga
            </p>
